;(function($){
	...
	$.fn.lubo=function(options){
		...
		return this.each(function(){
			var _lubo=$(this);
			var _box=_lubo.children('.lubo_box');
		...
		//根据图片的数量来生成圆点
			...
			function cir(){
				...
				var cir_box=_lubo.children('.cir_box');
		...
		//生成左右按钮
			...
			function Btn(){
				...
				var _btn=_lubo.children('.lubo_btn');
				// _lubo.mouseenter(function(event) {
				// 	/* Act on the event */
				// 	_btn.append('<div class="left_btn"><</div><div class="right_btn">></div>');

				// });
				// $(".main_warp").mouseout(function(event) {
				// 	/* Act on the event */
				// 		$(".right_btn").remove();
    //                  	$(".left_btn").remove();
			...
			//点击左面按钮
				...
				var cir_box=_lubo.children(_cirBox);

			 	var onLen=cir_box.children(_cirOn).val();
				...
				console.log(cir_box.children(Li));
				})
