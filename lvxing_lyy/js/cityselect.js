...
Vcity.CitySelector.prototype = {
    ...
    var test3=new Vcity.CitySelector({input:'romcity'});
    var test4=new Vcity.CitySelector({input:'ocity'});
    var test5=new Vcity.CitySelector({input:'leaveText'});