...
$('a:contains(真划算)').attr('href', '../discount/index.html');
$('a:contains(服装城)').attr('href', '../clothes/index.html');
...
$('.ct_temp .mt .tab li:first-child').addClass('tabli_chosen');
$('.ct_temp .mt .tab li:first-child').css('color', 'white');
