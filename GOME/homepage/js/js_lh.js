...
function togseabar(e) {
    ...
    if(cnt>=0){
	    ...
	    $('.elevator ul').children().eq(Math.round(cnt)).children().eq(0).css('display','none');
	    $('.elevator ul').children().eq(Math.round(cnt)).children().eq(1).css('display','block');
	    $('.elevator ul').children().eq(Math.round(cnt)).children().eq(1).css('background','transparent');
	    $('.elevator ul').children().eq(Math.round(cnt)).children().eq(1).css('color','#c81623');
	}
 }
var height=[];
 	for(i=0;i<11;++i){
